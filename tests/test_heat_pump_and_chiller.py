...
class TestCalculateCopsAndEers:
    ...
    def test_calculate_cops_and_eers_heat_pump_without_icing(self):
        ...
        cops_exp = pd.Series(
            [
                3.413615989515072, 3.018063731170336, 2.7131135416666665, 2.604589, 2.457159433962264, 5.66215
            ],
            index=self.date_range,
            name="no_unit",
        )
    ...
    def test_calculate_cops_and_eers_heat_pump_consider_icing(self, add_icing_to_csv):
        ...
        cops_exp = pd.Series(
            [
                3.413615989515072, 3.018063731170336, 2.7131135416666665, 2.0836712, 1.9657275471698115, 5.66215
            ],
            index=self.date_range,
            name="no_unit",
        )
